import LabaRugiInitiator from "../../presenter/laporan/initial_laporan_labarugi.js";
import initialSecurity from '../../presenter/setting/initial_security.js'
const LabarugiNota = {
	async render() {
		return `  

        <h1 class="h3 mb-2 text-gray-800">Laporan Laba Rugi Per Nota</h1>

        <div class="card shadow mb-4">
            
            <a href="#collapseCardExample" class="d-block card-header py-3" data-toggle="collapse"
                role="button" aria-expanded="true" aria-controls="collapseCardExample">
                <h6 class="m-0 font-weight-bold text-primary">Filter Laba Rugi</h6>
            </a>

            <div class="collapse show" id="collapseCardExample">

                <div class="card-body">
                    <form id="filterLabarugi">
        ...
        <div class="card shadow mb-4">
            <a href="#collapseInfoLabarugi" class="d-block card-header py-3" data-toggle="collapse"
                role="button" aria-expanded="true" aria-controls="collapseInfoLabarugi">
                <h6 class="m-0 font-weight-bold text-primary">Info Penjualan</h6>
            </a>

            <div class="collapse show" id="collapseInfoLabarugi">
                ...
                <div class="card-body">
                    <div class="col-sm-12">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <label for="pokokModal" class="col-form-label">Pokok Modal <b> : <span id="pokokModal">null</span></b></label>
                            </div>
                            <div class="col-sm-3">
                                <label for="labaRugi" class="col-form-label">Laba Rugi <b> : <span id="labaRugi">null</span></b></label>
                            </div>
                            <div class="col-sm-3">
                                <label for="labaOngkos" class="col-form-label">Laba + Ongkos <b> : <span id="labaOngkos">null</span></b></label>
                            </div>
                        </div>
                    </div>
                </div>
	...
	async afterRender() {
		...
		await initialSecurity.init({
			statePage: 'laba_rugi_nota'
		})
	},

	async _initialTable() {
		await LabaRugiInitiator.initLabarugiNota();
		await LabaRugiInitiator._setDate();
	},
