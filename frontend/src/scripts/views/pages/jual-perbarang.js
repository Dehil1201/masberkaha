...
const LaporanJualPerbarang = {
	async render() {
		return `
        <h1 class="h3 mb-2 text-gray-800">Laporan Jual / Barang</h1>
        ...
        <div class="card shadow mb-4">
            <a href="#collapseInfoPenjualan" class="d-block card-header py-3" data-toggle="collapse" role="button"
                aria-expanded="true" aria-controls="collapseInfoPenjualan">
                                ...
                                <table class="table">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td style="width:200px;font-weight:700;border: none;">Nominal Yang Diterima (Rp)
                                            </td>
                                            <td style="width:30px;border: none">:</td>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width:200px;font-weight:700;border: none;">Ongkos (Rp)</td>
                                            <td style="width:30px;border: none">:</td>
                                            <td style="border: none;" id="lblOngkos">null</td>
                                        </tr>
                                        <tr>
	...
	async afterRender() {
		...
		await initialSecurity.init({
			statePage: "laporan_jual_perbarang",
		});
	},

	async _initialTable() {
		await LaporanPerbarangInitiator.initJualPerbarang();
...
export default LaporanJualPerbarang;
